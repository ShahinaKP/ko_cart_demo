...
/******/ 	var hotCurrentHash = "e52e27eb8319746d5559"; // eslint-disable-line no-unused-vars
...
var productCategories = [{
  ...
  "products": [{
    ...
    "name": "Galaxy Note5 32GB",
    "price": 32.33,
    "image": "phonePlaceholder.png"
  }, {
    "name": "Galaxy S6 edge 32GB",
    "price": 103.42,
    "image": "phonePlaceholder.png"
  }, {
    "name": "Galaxy S5 32GB",
    ...
    "name": "Galaxy Note5 Dual Sim",
    "price": 75.16,
    "image": "phonePlaceholder.png"
  }, {
    "name": "Galaxy Mega 5.8 I9152",
    "price": 95.34,
    "image": "phonePlaceholder.png"
  }, {
    "name": "Galaxy Golden I9230",
    "price": 50.51,
    "image": "phonePlaceholder.png"
  }],
  "name": "Samsung",
...
var _productCategories = __webpack_require__(2);

var _productCategories2 = _interopRequireDefault(_productCategories);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

window.productCategories = _productCategories2.default;
...
var CartLine = function CartLine() {
    var self = this;
    self.category = _knockout2.default.observable();
    self.product = _knockout2.default.observable();
    self.quantity = _knockout2.default.observable(1);
    self.subtotal = _knockout2.default.computed(function () {
...
var shouter = new _knockout2.default.subscribable();
var selectBrandModel = function selectBrandModel() {
    this.brandHeader = "Choose Your Favourite Brand";
    this.showBrands = _knockout2.default.observable(true);

    this.brands = _knockout2.default.observableArray();
...
var selectMobileModel = function selectMobileModel() {
    this.showMobiles = _knockout2.default.observable(false);

    this.productsArray = _knockout2.default.observableArray();
    ...
    self.cartQty = _knockout2.default.observable(1);
    ...
    self.addToCart = function (event) {
        ...
        self.cartTotal = _knockout2.default.observable(50);
    };
    self.lines = _knockout2.default.observableArray([new CartLine()]); // Put one line in by default
    self.grandTotal = _knockout2.default.computed(function () {
        var total = 0;
        _jquery2.default.each(self.lines(), function () {
            total += this.subtotal();
        });
        return total;
    });
    ...
    self.save = function () {
        var dataToSave = _jquery2.default.map(self.lines(), function (line) {
            return line.product() ? {
    ...
    self.totalItems = _knockout2.default.computed(function () {
        var count = 0;
        _jquery2.default.each(self.lines(), function () {
            if (this.subtotal() > 0) {
...
var homeModel = function homeModel() {
    this.selectBrandModel = new selectBrandModel(), this.selectMobileModel = new selectMobileModel();
};

_knockout2.default.applyBindings(homeModel.call(window));
